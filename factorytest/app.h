...
extern int app_tfcard_speed_test(void);
...
extern int app_usb_sda1_speed_test(void);
extern int app_usb_sdb1_speed_test(void);
extern int app_usb_sdc1_speed_test(void);
